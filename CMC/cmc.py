...
while True:
    ...
    print ("=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=")
    print ("BTC USD Average = %d" %((krakenUSDLive + coinbUSDLive + btceUSDLive + btstampUSDLive + bitfinexUSDLive)/5))
    ...
    time.sleep(60) # 120 equals two minutes, you can ping it every second by putting a 1 in here
